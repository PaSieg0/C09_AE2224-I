...
print()
print(f'Cantilever span: ' + str(np.max(CNT_y)))
print(f'SBW span: ' + str(np.max(SBW_y)))
print(f'Strut span: ' + str(np.max(Strut_y)))
print()
print(f'Cantilever taper ratio: ' + str((CNT_chords[int(len(CNT_chords)/2)-1])/CNT_chords[0]))
print(f'SBW taper ratio: ' + str((SBW_chords[int(len(SBW_chords)/2)-1])/SBW_chords[0]))
print(f'Strut taper ratio: ' + str((Strut_chords[int(len(Strut_chords)/2)-1])/Strut_chords[0]))
...
plt.plot(Strut_y, Strut_chords, label = 'Strut')
plt.xlim(-0.25, 17.75)
plt.ylim(-3, 3)
