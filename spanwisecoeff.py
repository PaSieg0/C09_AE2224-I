...
plt.plot(df_low_fidelity_wing.iloc[:, 0], df_low_fidelity_wing.iloc[:, 2] + df_low_fidelity_strut.iloc[:, 2], label='Low fidelity sum')
plt.xlabel('y')
plt.ylabel('Cl')
plt.title('Cl-y')
plt.legend()
...
plt.plot(df_low_fidelity_wing.iloc[:, 0], df_low_fidelity_wing.iloc[:, 3] + df_low_fidelity_strut.iloc[:, 3], label='Low fidelity sum')
plt.xlabel('y')
plt.ylabel('Cd')
plt.title('Cd-y')
plt.legend()
...
plt.plot(df_low_fidelity_wing.iloc[:, 0], (df_low_fidelity_wing.iloc[:, 2] + df_low_fidelity_strut.iloc[:, 2])/(df_low_fidelity_wing.iloc[:, 3] + df_low_fidelity_strut.iloc[:, 3]), label='Low fidelity sum')
plt.xlabel('y')
plt.ylabel('Cl/Cd')
plt.title('ClCd-y')
plt.legend()
