...
def extract_and_coefficients(path, velocity, density, area):
...
if __name__ == "__main__":
    ...
    #-----------------CRUISE SBW----------------------
    data2plot[0] = extract_and_coefficients(r"./Dataset/SBW/CRUISE/Global_forces.txt", CRUISE_V, CRUISE_RHO, WING_AREA)

    #-----------------CLIMB SBW----------------------
    data2plot[1] = extract_and_coefficients(r"./Dataset/SBW/CLIMB/Global_forces.txt", CLIMB_V, CLIMB_RHO, WING_AREA)

    #-----------------CRUISE CNT----------------------
    data2plot[2] = extract_and_coefficients(r"./Dataset/CNT/CRUISE/Global_forces.txt", CRUISE_V, CRUISE_RHO, WING_AREA)

    #-----------------CLIMB CNT----------------------
    data2plot[3] = extract_and_coefficients(r"./Dataset/CNT/CLIMB/Global_forces.txt", CLIMB_V, CLIMB_RHO, WING_AREA)
